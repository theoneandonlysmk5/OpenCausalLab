...
/* This .do file cleans 2013 Household Survey income data for indviduals */
...
gen aux_main_income=s6_25a
gen aux_main_wage_period=s6_25b

gen aux_sec_income=s6_43a
gen aux_sec_wage_period=s6_43b
...
*(ii) production bonus 
gen bonus_monthly_main=s6_26a/12

*(iii) aguinaldos
gen aguinaldo_monthly_main=s6_26b/12
gen aguinaldo_yearly_main=s6_26b

*(iv) Comisiones
gen comision_main=s6_27a1
gen comision_period_main=s6_27a2
...
*(v) Overtime
gen overtime_main=s6_27b1
gen overtime_period_main=s6_27b2
...
gen extra_wages_sec=s6_42a1/12
...
gen inkind_`i'_period_main=s6_30`b'2 
gen inkind_`i'_main=s6_30`b'3
...
egen inkind_payments_sec=rowtotal(s6_42b1 s6_42c1)
...
gen `z'_cost_`i'=s6`b'`x'1
gen `z'_cost_`i'_period=s6`b'`x'2
...
gen retirement=s7_01a
gen transfer_veterans=s7_01b
gen transfer_disability=s7_01c
gen transfer_widows=s7_01d
...
gen y_elderly_transfer=s7_01eb
...
gen remittances_receive=(s7_06==1)
gen remittances_amount=s7_09a
gen remittances_period=s7_07

encode s7_09b, gen(s07_9b)
gen remittances_currency=s07_9b
...
*Save
save "${relabeled_data}/Income/EH2013_Income_relabel", replace
