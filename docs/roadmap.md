...
- [ ] Stabilize `core/` API (versioned, documented)
...
- [ ] Move more generic audit/reporting helpers from case studies into `core/reporting`
...
2. Anything that must work for every paper belongs in `core/`.
