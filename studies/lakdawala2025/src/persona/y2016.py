...
PERSONA_2016_KEEP = [
    ...
    "main_reason_work",  # reason child works (1 own income … 6 other)
    "hired_recruiters",  # 1 if hired through recruiters
    "work_conditions",  # whether child knows/approves employer conditions
