...
/* This .do file cleans 2015 Household Survey income data for indviduals */
...
*(iv) Comisiones
gen comision_main=s6c_27aa
gen comision_period_main=s6c_27ab
...
*(v) Overtime
gen overtime_main=s6c_27ba
gen overtime_period_main=s6c_27bb
...
gen extra_wages_sec=s6f_42a1/12
...
gen inkind_`i'_period_main=s6c_30`b'a 
gen inkind_`i'_main=s6c_30`b'b
...
egen inkind_payments_sec=rowtotal(s6f_42b1 s6f_42c1)
...
gen `z'_cost_`i'=s6`b'`x'a
gen `z'_cost_`i'_period=s6`b'`x'b
...
gen retirement=s7a_1a
gen transfer_veterans=s7a_1b
gen transfer_disability=s7a_1c
gen transfer_widows=s7a_1d
...
gen y_elderly_transfer=s7a_1eb
...
local kind "_3a _3b _3c _4a _4b _4c"
...
*Save
save "${relabeled_data}/Income/EH2015_Income_relabel", replace
